...
#endif
ConVar mat_texture_reload_frame_swap_workaround( "mat_texture_reload_frame_swap_workaround", CV_FRAME_SWAP_WORKAROUND_DEFAULT, 0,
...
#else
static ConVar mat_dxlevel("mat_dxlevel", "100", 0, "Current DirectX Level.");
#endif
...
static ConVar mat_forcehardwaresync( "mat_forcehardwaresync", IsPC() ? "1" : "0", FCVAR_NONE );

// Texture-related
static ConVar mat_trilinear(		"mat_trilinear", "0", FCVAR_NONE );
...
static ConVar mat_specular(			"mat_specular", "1", FCVAR_NONE, "Enable/Disable specularity for perf testing.  Will cause a material reload upon change." );
static ConVar mat_bumpmap(			"mat_bumpmap", "1", FCVAR_NONE );
...
static ConVar mat_softwarelighting( "mat_softwarelighting", "0", FCVAR_NONE );
...
#endif
static ConVar r_waterforcereflectentities(	"r_waterforcereflectentities", "0", FCVAR_NONE );
