...
//--------------------------------------------------------------------------------------------------------
void C_MolotovProjectile::Simulate()
{
												...
												CBaseCombatCharacter *owner, bool isIncGrenade )
{
	...
	molotov->m_pWeaponInfo = GetWeaponInfo( isIncGrenade ? WEAPON_INCGRENADE : WEAPON_MOLOTOV );
	molotov->SetIsIncGrenade( isIncGrenade );
	...
	Vector min = Vector( -2.0, -2.0, -2.0 );
	Vector max = Vector( 2.0, 2.0, 2.0 );
