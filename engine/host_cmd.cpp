...
void PerformKick( int iSearchIndex, char* szSearchString, bool bForceKick, const char* pszMessage );
...
CON_COMMAND( kickid_ex, "Kick a player by userid or uniqueid, provide a force-the-kick flag and also assign a message." )
{
	...
	PerformKick( iSearchIndex, szSearchString, bForce, pszMessage );
}
...
CON_COMMAND( kickid, "Kick a player by userid or uniqueid, with a message." )
{
	...
	PerformKick( iSearchIndex, szSearchString, false, pszMessage );
}
